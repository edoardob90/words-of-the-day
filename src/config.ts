...
export const posStyles = {
  ...
  Adjective:   { base: "bg-amber-100 text-amber-800",  hover: "hover:bg-amber-200",  active: "bg-amber-600 text-white" },
  Adverb:      { base: "bg-purple-100 text-purple-800", hover: "hover:bg-purple-200", active: "bg-purple-700 text-white" },
  Preposition: { base: "bg-rose-100 text-rose-800",    hover: "hover:bg-rose-200",   active: "bg-rose-700 text-white" },
} as const;
